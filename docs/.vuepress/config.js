module.exports = {
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      {
        text: '指南', link: '/pages/guidebook/', items: [
          { text: '介绍', link: '/pages/guidebook/' },
    ...
    repo: 'cuijiahuan', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'clare', // 必需
      href: 'https://github.com/cuijiahuan' // 可选的
    },
    social: { // 社交图标，显示于博主信息栏和页脚栏
      ...
      //     title: 'GitHub',
      //     link: 'https://github.com/cuijiahuan'
      //   },
      // ]
    },
    // valineConfig: {
